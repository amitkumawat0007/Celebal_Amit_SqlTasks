...
FROM 'F:\Database excel\New folder\Active.csv'
WITH
(
FIRSTROW = 2,
FIELDTERMINATOR= ',',
...
BULK INSERT [dbo].[inactive]
FROM 'F:\Database excel\New folder\inactive.csv'
WITH
(
FIRSTROW = 2,
FIELDTERMINATOR= ',',
...
-------------------------------------------------------------------------------------------
Drop table [over all data];
CREATE TABLE [over all data] (
[Username] NVARCHAR(100),
[Position ID] NVARCHAR(100),
[Employee Status] NVARCHAR(100),
[First Name] NVARCHAR(100),
